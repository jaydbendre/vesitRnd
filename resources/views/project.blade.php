...
$(document).ready(function(){
    $("#OngoingProjects").click(function(){  
       $('#target').html('<h3>Ongoing Projects</h3>                @foreach($ongoing as $project)                <div class="card mb-2 ">             <div class="row no-gutters">                        <div class="col-md-4">                            <img class="card-img" src="https://cdn3.iconfinder.com/data/icons/lifestyle/100/Noun_Project_20Icon_10px_grid-06-2-512.png" alt="Project" style="height: 20vh;">                        </div> <div class="col-md-8">        <div class="card-body">       <div class="card-title"><a href="/individual_project" style="color:black;text-decoration: none;"><b>Project Title:{{$project->title}}</b></a>  </div>              <div class="card-text">Project Type {{$project->type}} <br/> {{$project->description}} <br/> Project Domain {{$project->domain}}</div></div></div></div></div> @endforeach <button class="btn btn-primary">See More</button><br/> ')});
});

$(document).ready(function(){
    $("#ongoingai").click(function(){  
       $('#target').html('<h3>Ongoing Projects on AI</h3>                @foreach($ongoing as $project)    @if($project->domain == "AI")           <div class="card mb-2 ">             <div class="row no-gutters">                        <div class="col-md-4">                            <img class="card-img" src="https://cdn3.iconfinder.com/data/icons/lifestyle/100/Noun_Project_20Icon_10px_grid-06-2-512.png" alt="Project" style="height: 20vh;">                        </div> <div class="col-md-8">        <div class="card-body">       <div class="card-title"><a href="/individual_project" style="color:black;text-decoration: underline;"><b>Project Title:{{$project->title}}</b></a> <br/> Project Type {{$project->type}} </div>              <div class="card-text">{{$project->domain}}</div></div></div></div></div> @endif  @endforeach <br/>  <button class="btn btn-primary">See More</button>')});
});

$(document).ready(function(){
    $("#ongoingiot").click(function(){  
       $('#target').html('<h3>Ongoing Projects on IOT</h3>                @foreach($ongoing as $project)    @if($project->domain == "IOT")           <div class="card mb-2 ">             <div class="row no-gutters">                        <div class="col-md-4">                            <img class="card-img" src="https://cdn3.iconfinder.com/data/icons/lifestyle/100/Noun_Project_20Icon_10px_grid-06-2-512.png" alt="Project" style="height: 20vh;">                        </div> <div class="col-md-8">        <div class="card-body">       <div class="card-title"><strong>Project Title</strong> {{$project->title}} <br/> Project Type {{$project->type}} </div>              <div class="card-text">{{$project->domain}}</div></div></div></div></div> @endif  @endforeach <br/>  <button class="btn btn-primary">See More</button>')});
});

$(document).ready(function(){
    $("#ongoingdatamining").click(function(){  
       $('#target').html('<h3>Ongoing Projects on Data Mining</h3>                @foreach($ongoing as $project)    @if($project->domain == "data_mining")           <div class="card mb-2 ">             <div class="row no-gutters">                        <div class="col-md-4">                            <img class="card-img" src="https://cdn3.iconfinder.com/data/icons/lifestyle/100/Noun_Project_20Icon_10px_grid-06-2-512.png" alt="Project" style="height: 20vh;">                        </div> <div class="col-md-8">        <div class="card-body">       <div class="card-title"><strong>Project Title</strong> {{$project->title}} <br/> Project Type {{$project->type}} </div>              <div class="card-text">{{$project->domain}}</div></div></div></div></div> @endif  @endforeach <br/>  <button class="btn btn-primary">See More</button>')});
});

$(document).ready(function(){
    $("#indi_collab").click(function(){  
       $('#target').html('<h3>Industry Collaborated Projects</h3>  @foreach($industrial as $project)                <div class="card mb-2 ">                    <div class="row no-gutters">                        <div class="col-md-4">                            <img class="card-img" src="https://cdn3.iconfinder.com/data/icons/lifestyle/100/Noun_Project_20Icon_10px_grid-06-2-512.png" alt="Project" style="height: 20vh;">                        </div> <div class="col-md-8">        <div class="card-body">       <div class="card-title">Project ID {{$project->p_id}} Project Title </div>                                <div class="card-text">Domain {{$project->domain}}</div></div></div></div></div>@endforeach <button class="btn btn-primary">See More</button>')});
});
$(document).ready(function(){
    ...
    <div class="row">
        <div class="column col-xs-2">
            <div class="container container-fluid" style="float: left;margin-left: 0%;margin-right: auto;padding: 50px">
                    ...
                    <tr class="active"><td class="dropdown"><a href="#ongoingprojects" id="OngoingProjects" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Ongoing Projects</a>
                    ...
                    <tr><td class="dropdown"><a href="#Indi_collab" id="indi_collab" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Industry Collaborated</a>
                    ...
                    <tr><td class="dropdown"><a href="#Inhouse" id="inhouse" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Inhouse Projects</a>
                    ...
                    <tr><td class="dropdown"><a href="#Kht" id="kht" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Know-how-transfer</a>
                    ...
                    <tr><td class="dropdown"><a href="#Funded" id="funded" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Funded Projects</a>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <div class="card-title">
                                    <a href="/individual_project" style="color:black;text-decoration: none;"><b>Project Title:{{$project->title}}</b></a>    
                                </div>
                                <div class="card-text">Project Type:{{$project->type}}<br/>{{$project->description}}<br/>Project Domain {{$project->domain}}</div>
                            </div>
                        </div>
                    </div>
                </div>
